...
new __WEBPACK_IMPORTED_MODULE_1__modules_RevealOnScroll__["a" /* default */](__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".testimonials"), "60%");
...
class MobileMenu {
	constructor(){
		...
		this.menuIcon = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(".site-header__menu-icon"); // selecting icon
		this.menuContent = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(".site-header__menu-content"); // selecting nav links
		this.events();
	}

	events() {
		this.menuIcon.click(this.toggleTheMenu.bind(this)); //binding this because this in eventlisteners refers to html element
	}
...
class StickyHeader {
	constructor(){
		...
		this.pageSections = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(".page-sections");
...
class Modal {
	...
	openModal(){
		...
		return false; // will prevent default of going to top of page when clicked
	}
